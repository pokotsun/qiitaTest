...
import com.example.pokotsun.qiitaclient.client.ArticleClient
...
/**
 * Created by pokotsun on 17/09/18.
 */
...
//        activityTestRule.activity. = articleClient

        onView(withId(R.id.query_edit_text)).perform(typeText("suer:ngsw_taro"))
